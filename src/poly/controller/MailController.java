...
public class MailController {
	...
	public String sendMail(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
	...
	public String mailForm(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		log.info(this.getClass().getName()+"mail.sendMail start!");
